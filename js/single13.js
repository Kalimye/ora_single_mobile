...
var showLayer = document.querySelectorAll(".show-layer");
var layer = document.querySelector(".open-layer");
var close = document.querySelector(".close-layer");
showLayer.forEach(item => {
    item.onclick = function(){
